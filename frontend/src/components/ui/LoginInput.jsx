...
// for login and register input only
const LoginInput = ({
    label,
    type = "text",
    register,
    ...
    return (
        <div className="relative font-poppins text-xs w-full">
            <input
                ...
                className={cn(
                    "peer h-10 w-full border border-gray-100 text-sm text-slate-900 p-2 -z-50 placeholder-transparent bg-lamaWhite focus:outline-none focus:border-slate-200 font-robotos font-medium shadow-sm rounded-sm  ",
                    className
                )}
                {...inputProps}
